...
The nRF Connect for Desktop launcher is the starting application for installing and managing [nRF Connect for Desktop apps](https://docs.nordicsemi.com/bundle/swtools_docs/page/index.html).
