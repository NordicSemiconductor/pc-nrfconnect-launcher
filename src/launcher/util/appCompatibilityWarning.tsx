...
const checkJLinkRequirements: AppCompatibilityChecker = async (
    ...
    if (
        ...
        return incompatible(
            `Untested version V${actualVersionNumber} of SEGGER J-Link found, expected at least version V${expectedVersionNumber}`,
            <div className="tw-flex tw-flex-col tw-gap-2">
                <div>
                    This app was tested with SEGGER J-Link V
                    {expectedVersionNumber} but only version V
                    {actualVersionNumber} was found on your system.
                </div>
